...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(GuessMyNumber::typeid));
			...
			// enterButton1
			// 
			this->enterButton1->Location = System::Drawing::Point(185, 306);
			this->enterButton1->Margin = System::Windows::Forms::Padding(6, 6, 6, 6);
			this->enterButton1->Name = L"enterButton1";
			this->enterButton1->Size = System::Drawing::Size(138, 42);
			...
			// clearButton1
			// 
			this->clearButton1->Location = System::Drawing::Point(44, 395);
			this->clearButton1->Margin = System::Windows::Forms::Padding(6, 6, 6, 6);
			this->clearButton1->Name = L"clearButton1";
			this->clearButton1->Size = System::Drawing::Size(138, 42);
			...
			// exitButton1
			// 
			this->exitButton1->Location = System::Drawing::Point(323, 395);
			this->exitButton1->Margin = System::Windows::Forms::Padding(6, 6, 6, 6);
			this->exitButton1->Name = L"exitButton1";
			this->exitButton1->Size = System::Drawing::Size(138, 42);
			...
			// numberTextBox1
			// 
			this->numberTextBox1->Location = System::Drawing::Point(185, 207);
			this->numberTextBox1->Margin = System::Windows::Forms::Padding(6, 6, 6, 6);
			this->numberTextBox1->Name = L"numberTextBox1";
			this->numberTextBox1->Size = System::Drawing::Size(180, 29);
			...
			this->enterNumberLabel1->Location = System::Drawing::Point(39, 212);
			this->enterNumberLabel1->Margin = System::Windows::Forms::Padding(6, 0, 6, 0);
			this->enterNumberLabel1->Name = L"enterNumberLabel1";
			this->enterNumberLabel1->Size = System::Drawing::Size(138, 25);
			...
			this->label1->Location = System::Drawing::Point(22, 66);
			this->label1->Margin = System::Windows::Forms::Padding(6, 0, 6, 0);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(427, 29);
