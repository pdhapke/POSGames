...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->pictureBox1->Location = System::Drawing::Point(1377, 1490);
			this->pictureBox1->Margin = System::Windows::Forms::Padding(6);
			this->pictureBox1->Name = L"pictureBox1";
			this->pictureBox1->Size = System::Drawing::Size(183, 78);
			...
			this->SpaceInvader0->Location = System::Drawing::Point(22, 22);
			this->SpaceInvader0->Margin = System::Windows::Forms::Padding(6);
			this->SpaceInvader0->MaximumSize = System::Drawing::Size(183, 185);
			this->SpaceInvader0->Name = L"SpaceInvader0";
			this->SpaceInvader0->Size = System::Drawing::Size(147, 111);
			...
			this->SpaceInvaderTimer->Tick += gcnew System::EventHandler(this, &SpaceInvaders::timer1_Tick);
			// 
			// SpaceInvader4
			// 
			this->SpaceInvader4->Image = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"SpaceInvader4.Image")));
			this->SpaceInvader4->Location = System::Drawing::Point(653, 22);
			this->SpaceInvader4->Margin = System::Windows::Forms::Padding(6);
			this->SpaceInvader4->MaximumSize = System::Drawing::Size(183, 185);
			this->SpaceInvader4->Name = L"SpaceInvader4";
			this->SpaceInvader4->Size = System::Drawing::Size(147, 111);
			...
			this->SpaceInvader3->Location = System::Drawing::Point(495, 22);
			this->SpaceInvader3->Margin = System::Windows::Forms::Padding(6);
			this->SpaceInvader3->MaximumSize = System::Drawing::Size(183, 185);
			this->SpaceInvader3->Name = L"SpaceInvader3";
			this->SpaceInvader3->Size = System::Drawing::Size(147, 111);
			...
			this->SpaceInvader2->Location = System::Drawing::Point(337, 22);
			this->SpaceInvader2->Margin = System::Windows::Forms::Padding(6);
			this->SpaceInvader2->MaximumSize = System::Drawing::Size(183, 185);
			this->SpaceInvader2->Name = L"SpaceInvader2";
			this->SpaceInvader2->Size = System::Drawing::Size(147, 111);
			...
			this->SpaceInvader1->Location = System::Drawing::Point(180, 22);
			this->SpaceInvader1->Margin = System::Windows::Forms::Padding(6);
			this->SpaceInvader1->MaximumSize = System::Drawing::Size(183, 185);
			this->SpaceInvader1->Name = L"SpaceInvader1";
			this->SpaceInvader1->Size = System::Drawing::Size(147, 111);
			...
			this->SpaceInvader6->Location = System::Drawing::Point(968, 22);
			this->SpaceInvader6->Margin = System::Windows::Forms::Padding(6);
			this->SpaceInvader6->MaximumSize = System::Drawing::Size(183, 185);
			this->SpaceInvader6->Name = L"SpaceInvader6";
			this->SpaceInvader6->Size = System::Drawing::Size(147, 111);
			...
			this->SpaceInvader5->Location = System::Drawing::Point(810, 22);
			this->SpaceInvader5->Margin = System::Windows::Forms::Padding(6);
			this->SpaceInvader5->MaximumSize = System::Drawing::Size(183, 185);
			this->SpaceInvader5->Name = L"SpaceInvader5";
			this->SpaceInvader5->Size = System::Drawing::Size(147, 111);
			...
			this->BulletTimer->Tick += gcnew System::EventHandler(this, &SpaceInvaders::BulletTimer_Tick);
			// 
			// Bullet
			// 
			this->Bullet->BackColor = System::Drawing::Color::Red;
			this->Bullet->Location = System::Drawing::Point(22, 1514);
			this->Bullet->Margin = System::Windows::Forms::Padding(6);
			this->Bullet->Name = L"Bullet";
			this->Bullet->Size = System::Drawing::Size(18, 54);
			...
			this->ClientSize = System::Drawing::Size(3454, 1581);
