...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// option6
			// 
			this->option6->Location = System::Drawing::Point(262, 192);
			...
			// option5
			// 
			this->option5->Location = System::Drawing::Point(139, 192);
			...
			// option4
			// 
			this->option4->Location = System::Drawing::Point(14, 192);
			...
			// option3
			// 
			this->option3->Location = System::Drawing::Point(262, 78);
			...
			// option2
			// 
			this->option2->Location = System::Drawing::Point(139, 78);
			...
			// option1
			// 
			this->option1->Location = System::Drawing::Point(14, 78);
			...
			this->lblTitle->Location = System::Drawing::Point(60, 9);
			...
			this->Description->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 9.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->Description->Location = System::Drawing::Point(120, 52);
			...
			// restartBut
			// 
			this->restartBut->Location = System::Drawing::Point(107, 289);
			...
			// btnExit
			// 
			this->btnExit->Location = System::Drawing::Point(198, 289);
			...
			this->ClientSize = System::Drawing::Size(378, 324);
